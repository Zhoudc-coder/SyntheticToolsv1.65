...
from config import (
    ...
    AUTO_CHECK_PREV_DAYS, SPECIAL_MODE_DEFAULT, CHECK_DUPLICATES_DEFAULT
)
from file_parser import parse_filename, ParsedBoxInfo
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.resize(1200, 950)   # 修改：略微增大宽度
        self.setMinimumSize(1100, 800)   # 修改：最小宽度也相应调整
    ...
    def _init_ui(self):
        ...
        file_layout.setSpacing(4)   # 修改：缩小间距，降低组高度
        file_layout.setContentsMargins(15, 8, 15, 8)   # 修改：缩小上下边距
        ...
        output_layout.setSpacing(20)   # 保留较大间距用于输入框行
        ...
        # ===== 两行提示文字放入独立容器，适当增加彼此间距 =====
        hint_widget = QWidget()
        hint_layout = QVBoxLayout(hint_widget)
        hint_layout.setContentsMargins(0, 0, 0, 0)
        hint_layout.setSpacing(6)   # 修改：设置为 6，略微增大两行提示文字间距
